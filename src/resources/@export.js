...
let qtd2 = 0; async function funLibrary(infOk) {
    ...
    else if (lib === '_clipboard') { let { default: clipboard, } = await import('clipboardy'); gloWin[lib] = clipboard; }
    ...
    else if (lib === '_getFolderSize') { let { default: getFolderSize, } = await import('get-folder-size'); gloWin[lib] = getFolderSize; }
