...
async function logsDelOld(inf) {
    ...
    try {
        ...
        let pathsToDel = [
            ...
            { 'daysKeep': globalWindow.devMaster == 'AWS' ? 7 : 31, 'path': `${letter}:/ARQUIVOS/PROJETOS/Chrome_Extension/log/Registros`, },
            { 'daysKeep': globalWindow.devMaster == 'AWS' ? 7 : 31, 'path': `${letter}:/ARQUIVOS/PROJETOS/Chrome_ExtensionOld/log/Registros`, },
            { 'daysKeep': globalWindow.devMaster == 'AWS' ? 7 : 31, 'path': `${letter}:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Registros`, },
            { 'daysKeep': globalWindow.devMaster == 'AWS' ? 7 : 31, 'path': `${letter}:/ARQUIVOS/PROJETOS/URA_Reversa/log/Registros`, },
            { 'daysKeep': globalWindow.devMaster == 'AWS' ? 7 : 31, 'path': `${letter}:/ARQUIVOS/PROJETOS/WebScraper/log/Registros`, },
            { 'daysKeep': globalWindow.devMaster == 'AWS' ? 7 : 31, 'path': `${letter}:/ARQUIVOS/PROJETOS/WebSocket/log/Registros`, },
            { 'daysKeep': globalWindow.devMaster == 'AWS' ? 7 : 31, 'path': `${letter}:/ARQUIVOS/PROJETOS/WebSocketOld/log/Registros`, },
        ]
...
if (eng) { // CHROME
    window['logsDelOld'] = logsDelOld;
} else { // NODEJS
    global['logsDelOld'] = logsDelOld;
}
