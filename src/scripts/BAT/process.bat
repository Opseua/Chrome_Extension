...
if not "!old!" == "!old:E=!" ( set "ret2=!old!" & goto IGNORE_CHECK_IS_RUNNING )
...
if "!actionRun!" == "ON" (
	...
	if not "!action!" == "!action:HIDE=!" (
		...
		!3_BACKGROUND! /NOCONSOLE /RUNAS "cmd.exe /c title CMD_!programExe!_CMD& !programExePath! !fileScript! & ping -n 2 -w 1000 127.0.0.1 > nul & call !fileChrome_Extension!\src\scripts\BAT\process.bat !arg1! !arg2! !arg3! !restartOnStop! !arg5! !arg6!"
	) else (
